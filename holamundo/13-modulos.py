...
from math import pi as PI_ERIC # para darle una variable
print(PI_ERIC)
...
# # itertools: Ofrece herramientas para crear iteradores eficientes y complejos.
# import itertools
...
# # numpy: Proporciona soporte para arrays y matrices grandes y multidimensionales.
# import numpy as np
# arr = np.array([1, 2, 3])
# print(arr)  # Imprime [1 2 3]

# # pandas: Ofrece estructuras de datos y herramientas de análisis de datos.
# import pandas as pd
# df = pd.DataFrame({'A': [1, 2, 3], 'B': [4, 5, 6]})
# print(df)  # Imprime el DataFrame con las columnas A y B

# # matplotlib: Utilizado para crear visualizaciones de datos en 2D.
# import matplotlib.pyplot as plt
# plt.plot([1, 2, 3], [4, 5, 6])
# plt.show()  # Muestra un gráfico de línea
...
# # scikit-learn: Ofrece herramientas para el análisis de datos y machine learning.
# from sklearn.linear_model import LinearRegression
# import numpy as np
# X = np.array([[1, 1], [1, 2], [2, 2], [2, 3]])
# y = np.dot(X, np.array([1, 2])) + 3
# reg = LinearRegression().fit(X, y)
# print(reg.coef_)  # Imprime los coeficientes del modelo

# # flask: Micro framework para el desarrollo de aplicaciones web en Python.
